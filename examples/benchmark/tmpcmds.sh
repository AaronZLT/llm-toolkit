...
CUDA_VISIBLE_DEVICES=0,1 DS_SKIP_CUDA_CHECK=1 HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 accelerate launch benchmark.py --data_path $DATASET --dataset alpaca --output_dir output --logging_strategy steps --logging_steps 1 --save_strategy no --save_steps 1 --dataloader_num_workers 32 --remove_unused_columns False --do_train --ddp_find_unused_parameters False --overwrite_output_dir --bf16 --profiler no --profiler_warmup_step 3 --max_steps 5 --per_device_train_batch_size 4 --max_memory_MB 80000 --hard_padding True --source_max_len 512 --target_max_len 512 --model_name_or_path $LLAMA7B

CUDA_VISIBLE_DEVICES=0,1,2,3 DS_SKIP_CUDA_CHECK=1 HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 accelerate launch benchmark.py --data_path $DATASET --dataset alpaca --output_dir output --logging_strategy steps --logging_steps 1 --save_strategy no --save_steps 1 --dataloader_num_workers 32 --remove_unused_columns False --do_train --ddp_find_unused_parameters False --overwrite_output_dir --bf16 --profiler no --profiler_warmup_step 3 --max_steps 5 --per_device_train_batch_size 4 --max_memory_MB 80000 --hard_padding True --source_max_len 512 --target_max_len 512 --model_name_or_path $LLAMA7B
